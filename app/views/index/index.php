...
<div
	...
	<div class="jumbotron">
		<h1>
			Freekore Versi&oacute;n
			<?php echo fkore::$version?>
		</h1>
		<p>Felicidades! est&aacute;s usando freekore con bootstrap</p>
		<p>	Esta pagina es ejecutada desde: <b>app/controllers/index.controller.php</b>	</p>
		<p>	La vista se encuentra en: <b>app/views/index.php</b>	</p>
	...
	<div class="dropdown theme-dropdown clearfix">
		<a id="dropdownMenu1" href="#" role="button"
			class="sr-only dropdown-toggle" data-toggle="dropdown">Dropdown <b
			class="caret"></b>
		</a>
		...
		<div class="col-sm-4">
			<div class="list-group">
				<a href="#" class="list-group-item active">
					...
					<p class="list-group-item-text">Donec id elit non mi porta gravida
						at eget metus. Maecenas sed diam eget risus varius blandit.</p> </a>
	...
	<div class="well">
		<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas
			...
			erat porttitor ligula, eget lacinia odio sem nec elit. Aenean lacinia
